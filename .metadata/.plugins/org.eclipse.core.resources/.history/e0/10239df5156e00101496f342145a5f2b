...
import com.smartbill360.model.ForgetPasswordModel;
...
public class CommonController {
	...
	public ResponseEntity<ApiResponse> updatePassword(@RequestBody ForgetPasswordModel model){
		...
		if (auth != null && auth.getPrincipal() instanceof User user) {
			...
			if(flag) {
				...
				return ResponseEntity.status(HttpStatus.UNAUTHORIZED).body(new ApiResponse(false, null, "Old Password does not match"));
			}
		}else {
