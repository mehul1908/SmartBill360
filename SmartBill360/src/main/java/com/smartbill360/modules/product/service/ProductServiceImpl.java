...
public class ProductServiceImpl implements ProductService {
	...
	@Override
	public Product getProductById(Integer productId, boolean isActive) {
		Optional<Product> prodOp = prodRepo.findByIdAndIsActive(productId, isActive);
		if (prodOp.isEmpty())
			return null;
